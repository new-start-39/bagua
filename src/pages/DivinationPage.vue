...
h1 { margin: 0; color: #f1f4ff; font-size: clamp(54px,8vw,112px); letter-spacing: .06em; line-height: 1.08; em,.accent { color: #5cf5d4; font-style: normal; text-shadow: 0 0 30px rgba(92,245,212,.3); } }
...
@media (max-width: 760px) { .welcome-view { display: flex; min-height: calc(100vh - 80px); flex-direction: column; justify-content: center; gap: 30px; text-align: center; }.hero-copy h1 { font-size: clamp(52px,17vw,72px); letter-spacing: .05em; line-height: 1.12; }.compass-stage { width: min(78vw,370px); }.start-panel { margin: 0; }.casting-grid { grid-template-columns: 1fr; }.section-heading { align-items: flex-start; margin-bottom: 28px; }.coins-panel { min-height: 360px; }.coin-trail { width: 300px; } }
</style>
